##
setwd("E:\\—ßœ∞œ‡πÿ\\R\\China-s-Internal-Migrants-and-Their-Lives\\Codes&Datasets\\Flow")
##
rm(list=ls())
...
circos.trackPlotRegion(ylim = c(0, 1), factors = df1$region, track.height=0.1, 
                       ...
                       panel.fun = function(x, y) {
                         ...
                         #plot axis
                         circos.axis(labels.cex=0.8, direction = "outside", major.at=seq(0,floor(df1$xmax)[i]), minor.ticks=5,
...
df2<-subset(df2, m>quantile(m,0.40))
